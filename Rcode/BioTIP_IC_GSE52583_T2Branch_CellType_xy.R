...
# save( simuBioTIP_g,  simuBioTIP_s, file="F:/projects/BioTIP/result/GSE52583/AT2_simuBioTIP.RData", compress=TRUE)
 ...
 par(mfrow=c(1,2))
 ## global matplot 
 plot_Ic_Simulation(BioTIP_score, simuBioTIP_g, las = 2, ylab="Ic*",ylim=c(0,1),
                    main= paste("CTS.E18 (",n," transcripts)"),
                    fun="boxplot", which2point= 3)
 plot_SS_Simulation(BioTIP_score, simuBioTIP_s, xlim=c(0,1.3),
