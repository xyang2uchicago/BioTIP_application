...
pdf(file = 'ROutputFigs/GSE115575/weighted_MCI.pdf', width=14)
...
load(file = '../Applications/outPut.Rdata/GSE115575/weighted_cyclic_loess_signature.RData')
...
save( simuIc_g,  simuIc_s, file="F:/projects/BioTIP/result/Antonio_Feliciano/GSE115575_Holly/simuBioTIP_09302020.RData", compress=TRUE)

# load(file="F:/projects/BioTIP/result/Antonio_Feliciano/GSE115575_Holly/simuBioTIP.RData")  
load(file="F:/projects/BioTIP/result/Antonio_Feliciano/GSE115575_Holly/simuBioTIP_09302020.RData")  
...
plot_SS_Simulation(Ic_score, simuIc_g, 
                   ...
                   ylab=NULL)
plot_Ic_Simulation(Ic_score, simuIc_s, las = 2, ylab="Ic*",ylim=c(0.2,1.2),
                   main=paste(length(CTS), x,"genes", "\n","vs. ",C, "sample-permutations"),
                   fun="matplot", which2point= x)
plot_SS_Simulation(Ic_score, simuIc_s, 
                   main = "Delta IC*, labelling shuffling", 
...
dev.copy2pdf(file=paste0("ROutputFigs/GSE115575/BioTIP_vsSimulation_",length(CTS),"CTS_09302020.pdf"))
