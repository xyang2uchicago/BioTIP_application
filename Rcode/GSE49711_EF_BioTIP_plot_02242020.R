# This code present BioTIP-identified CTSs from data of GSE49711, event-free samples
...
source("F:/projects/BioTIP/source/simulation_Ic.details.R")
...
C= 1000
(n <- length(CTS)) # 137
BioTIP_score <- getIc(count_matrix, samplesL, as.character(CTS), fun="BioTIP")
BioTIP_score
# LR-EFS    ILR-EFS    HIR-EFS     HR-EFS 
#0.04535491 0.65355090 0.09523305 0.05504268
...
dev.copy2pdf(file=paste0("ROutputFigs/GSE49711/Dataset2_EF_BioTIP_vsSimulation_",length(CTS),"CTS_4publication.pdf"))
...
C= 1000
n <- length(CTS)
Ic_score <- getIc(count_matrix, samplesL, CTS, fun="cor")
Ic_score
#LR-EFS   ILR-EFS   HIR-EFS    HR-EFS 
...
dev.copy2pdf(file=paste0("ROutputFigs/GSE49711/Dataset2_EF_Ic_vsSimulation_",length(CTS),"CTS_4publication.pdf"))
