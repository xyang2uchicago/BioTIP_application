...
dev.copy2pdf(file = 'ROutputFigs/GSE6136/MCI_Ic_GSE6136_5states_5per_09292020.pdf')
...
##### Alternatively, test on the non-log-transformed data , used for Supplmentary Fig S3 ###################
