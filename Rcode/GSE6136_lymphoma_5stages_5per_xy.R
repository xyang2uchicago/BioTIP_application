# This code performs CTS analysis on the log2-transformed gene expressional data of GSE6136, using BioTIP (v.1.1.0).
...
save(pre5s_5per, file = 'outPut.Rdata/GSE6136/pre5s_5per_preselect_GSM142418.rData')
...
#Length: 141
save(CTS, file = 'outPut.Rdata/GSE6136/CTS.GSE6136_5states_5per.rData')
...
dev.copy2pdf(file = 'ROutputFigs/GSE6136/BioTIP_GSE6136_5states_5per.pdf')
