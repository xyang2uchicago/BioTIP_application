...
## Instead, preselect the top 5% transcripts with the highest relative standard deviation
...
dev.copy2pdf(file = 'bar_GSE6136_5states_1per.pdf')
...
#Length: 141(5), 35(1)
save(CTS, file = 'CTS.GSE6136_5states_1per.rData')
...
dev.copy2pdf(file = 'MCI_Ic_GSE6136_5states_1per.pdf')
